...
# Display all past results under the search bar
st.write("### All Past Results")
for date, result in sorted(all_results.items(), reverse=True):
    st.write(f"**{date}**")
    display_kerala_lottery(result)
